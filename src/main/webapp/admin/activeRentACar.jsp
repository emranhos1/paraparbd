            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="display-6 text-center ">All Active Rent A Car</h2><hr>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div style="border: none;" class="modal-body card card-register mx-auto">
                            ...
                            <form action="../InactiveRentACarServlet" accept-charset="UTF-8" method="post" role="form" class="form-horizontal">
