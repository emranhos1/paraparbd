            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="display-6 text-center ">All Active Car</h2><hr>
                    </div>
                </div>
                ...
                <!--Specification Dialog for inActive-->
                <div class="modal fade" id="addSpecInactive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Are You Sure To Inactive This Car?</h5>
                            ...
                            <div style="border: none;" class="modal-body card card-register mx-auto">
                                    ...
                                    <form action="../InactiveCarServlet" accept-charset="UTF-8" method="post" role="form" class="form-horizontal">
                                        <input  type="hidden" id="rentACarTableId" name="rentACarTableId" class="form-control" value="" readonly/>
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary btn-block">Inactive</button>
                                            </div>
                                        </div>
                                    </form>
...
//                                AfterLoadTable();
            ...
            $(document).on("click", ".open-spceDialog-Inactive", function () {
