<%-- 
    ...
    Created on : Aug 3, 2018, 6:44:06 PM
    Author     : Shahjahan
--%>
...
<html>
    ...
    <body>
        ...
        <!-- main content start-->
        <section id="allConfirmedbooking">
            <div class="container">
                <div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="display-6 text-center ">All Confirmed Booking</h2><hr>
                    </div>
                </div>
                ...
                <div class="table-responsive panel-body col-sm-12">
