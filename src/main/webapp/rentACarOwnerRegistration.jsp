...
<html>
    <head>
        ...
        <title>Rent A Car Owner Registration</title>
        <!--head-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="info-contact text-center">
                            ...
                            <h2 class="display-6">Rent a car owner Registration</h2><hr>
                        </div>
                    </div>

                    <form id="form" role="form" action="RentECarRegServlet" method="post" class="form-horizontal"  enctype="multipart/form-data">
                        <div id="company" modal-body>
                            <div class="form-group">
                                <div class="input-group mb-3 col-12  input-group-sm input-group-lg ">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="ownerPhoto">Choose file</label>
                                        <input name="ownerPhoto" id="ownerPhoto" type="file" name="image" class="custom-file-input" /><br>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                    ...
                                    <input class="form-control" type="text" value="" name="firstName" id="firstName" placeholder="First Name" required>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3  col-12 input-group-sm input-group-lg">
                                    ...
                                    <!--                                <select class="custom-select" id="inputGroupSelect01">
                                                                        <option selected>Division Name</option>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3 col-12 input-group-sm input-group-lg">
                                    ...
                                    <!--                                <select class="custom-select" id="inputGroupSelect01">
                                                                        <option selected>Police Station Name</option>
                                                                    </select>-->
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                    ...
                                    <textarea class="form-control input" type="text" value="" name="address" id="address" placeholder="Address" required></textarea>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                    ...
                                    <!--<input id="msg" type="text" class="form-control" name="msg" id="exampleInputPassword1" placeholder="Zip Code" maxlength="13">-->
                        ...
                        <div id="user">
                            <div class="form-group">
                                <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                    ...
                                    <!--<input class="form-control" id="inputPhone" maxlength="13" name="phone" required="required" placeholder="NID Number" size="3" title="" type="tel" value="">-->
                            ...
                            <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupFileAddon01"><i class="fa fa-camera"></i></span>
                                </div>
                                <div class="custom-file">
                                    <!--                                <input type="file" class="custom-file-input" id="inputGroupFile01">
                                                                    <label class="custom-file-label" for="inputGroupFile01">Choose NID file</label>-->
                                    <label class="label">Choose NID Photo</label>
                                    <input class="form-control input" type="file" accept="image/*" value="" name="nidPhoto" id="nidPhoto" title = "Choose NID Photo" required/>
                            ...
                            <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                ...
                                <div class="custom-file">                                
                                    <!--                                <input type="file" class="custom-file-input" id="inputGroupFile01">
                                                                    <label class="custom-file-label" for="inputGroupFile01">Choose TIN file</label>-->
                            ...
                            <div class="input-group mb-3  col-12 input-group-sm input-group-lg ">
                                ...
                                <div class="custom-file">                                
                                    <!--                                <input type="file" class="custom-file-input" id="inputGroupFile01">
                                                                    <label class="custom-file-label" for="inputGroupFile01">Choose Trade License</label>-->
                                    <label class="label">Choose Trade License Photo</label>
                                    <input class="form-control input" type="file" accept="image/*" value="" name="tradeLicensePhoto" id="tradeLicensePhoto" title = "Choose Trade Photo" required/>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3 ml-5">
                                    ...
                                    <!--                                <button type="submit" class="btn btn-success ml-4">Back</button>
                                                                    <button type="submit" class="btn btn-success ml-2">Registration</button>-->
                                    <button name="pre_btn" type="button"  class="btn btn-success ml-4 btn-primary" id="pre_btn">Back</button>
                                    <button type="submit" class="btn btn-success ml-2 btn-success" id="reg_btn">Registration</button>
                                </div>
                            </div>
                        </div>
                        <center><span>Not a user?<a href="commonUserRegistration.jsp">Sign Up</a></span></center>
                    </form>
                </div>
            </div>
        </section>
