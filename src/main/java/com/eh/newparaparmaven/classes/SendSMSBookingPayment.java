...
public class SendSMSBookingPayment {
    ...
    public static String sendSMSPayment(int commonUserId, int orderNo, int advancePay) {
        ...
        try {
            ...
            Logger.getLogger(SendSMSBookingPayment.class.getName()).log(Level.SEVERE, null, ex);
        } finally{
            try {
                con.close();
                rs.close();
        ...
        data = sendSMS(phoneNo, orderNo, advancePay);
        return data;
    }

    public static String sendSMS(String PHONE, int orderNo, int advancePay) {
        HttpURLConnection connection = null;
        try {
            String API = "75762";
            String TEXT = "TEXT";
            String textBody = "Your Order No " + orderNo + ", Please Bkash "+advancePay+"Tk To 01730578942 For Booking Money as soon as posible.\n parapar \n Hot Line: 09617 111 999";
