...
public class SendSMSForConfirmBooking {
    ...
    public static String sendSMSConfirmBooking(int commonUserId, int orderNo) {
        ...
        try {
            ...
            Logger.getLogger(SendSMSForConfirmBooking.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                con.close();
                rs.close();
    ...
    public static String sendSMS(String PHONE, int orderNo) {
        ...
        try {
            String API = "75762";
            String TEXT = "TEXT";
            String textBody = "Your Booking is Confirmed Order No " + orderNo + ", Please wait For Call From Driver For Picup.\n parapar \n Hot Line: 09617 111 999";
