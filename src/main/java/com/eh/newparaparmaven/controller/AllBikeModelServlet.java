...
public class AllBikeModelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            conrs = GetModel.getBikeModelTable();
            ...
            int i = 0;
            while (rs.next()) {
                bikeModelId[i] = rs.getInt("bike_model_id");
            ...
            Logger.getLogger(AllBikeModelServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                con.close();
                rs.close();
