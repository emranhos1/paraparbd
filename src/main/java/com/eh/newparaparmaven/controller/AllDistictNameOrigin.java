...
public class AllDistictNameOrigin extends HttpServlet {

    private String divisionNameDropDownOrigin;
    private conRs conrs;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            divisionNameDropDownOrigin = new String(request.getParameter("divisionNameDropDownOrigin").getBytes("ISO-8859-1"), "UTF-8");
            conrs = GetDistrict.getDistrictForDivision(divisionNameDropDownOrigin);
            ...
            Logger.getLogger(AllDistictNameOrigin.class.getName()).log(Level.SEVERE, null, ex);
        } finally{
            try {
                con.close();
                rs.close();
