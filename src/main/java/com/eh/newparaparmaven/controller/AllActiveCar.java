...
public class AllActiveCar extends HttpServlet {

    private conRs getActiveCar;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            getActiveCar = GetCar.getActiveCar();
            con = getActiveCar.getCon();
            rs = getActiveCar.getRs();
            pstm = getActiveCar.getPstm();
            ...
            for (i = 0; i < orgRow; i++) {
                ...
                response.getWriter().write("<tr>"
                        ...
                        + "<a data-toggle='modal' data-rentacartableid='" + rentACarTableId[i] + "' class='btn btn-primary open-spceDialog-Inactive' href='#addSpecInactive' >Inactive</a>"
                        + "</button>        "
                        + "</td>"
                        + "</tr>");
            }
            ...
            Logger.getLogger(AllActiveCar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
